...
export default function ScreenshotsCarousel({
  ...
  if (screenshots.length === 0) {
    return (
      <div className="lg:w-[1360px] mx-auto h-48 flex items-center justify-center">
  ...
  return (
    <>
      ...
      <div
        ...
        className="flex gap-4 overflow-x-auto hide-scrollbar lg:w-[1360px] mx-auto cursor-pointer"
      >
