          ...
          >
            ...
            <div className="relative z-10 grid h-full min-h-0 grid-rows-[auto_1fr_auto] gap-3 p-3 [scrollbar-gutter:stable] [-webkit-overflow-scrolling:touch] touch-pan-y sm:gap-4 sm:p-4">
              ...
              <div className="grid min-h-0 gap-3 overflow-y-auto pr-1">
                ...
                <div
                  className={`grid min-h-[170px] grid-rows-[auto_1fr] rounded-[24px] border border-white/12 bg-white/8 p-3.5 backdrop-blur-xl md:min-h-[220px]`}
                >
...
//   const [progress, setProgress] = useState(initialProgress ?? 0);
//   const [progressMode, setProgressMode] = useState<"normal" | "chapters">(
//     "normal",
//   );
...
//       ? Math.max(1, Math.round((progress / 100) * chapters))
//       : 0;
...
//                               onChange={(e) =>
//                                 setProgressMode(
//                                   e.target.value as "normal" | "chapters",
//                                 )
//                               }
//                               className="
//         rounded-xl
...
//                               max={100}
//                               step={
//                                 progressMode === "chapters" ? 100 / chapters : 1
//                               }
//                               value={progress}
//                               disabled={!gameIsReleased}
//                               onChange={(e) =>
