...
//         .filter(
//           (d) =>
//             !d.data().archived && d.data().type === "game_release_change",
//         )
//         .map((docSnap) => {
//           const data = docSnap.data() as FireNotificationDoc;
//           return {
...
//   // The panel intentionally loads only the latest notifications. Keep the
//   // badge separate so an unread item cannot disappear just because newer,
//   // already-read items move it beyond that list limit.
//   useEffect(() => {
//     if (!uid) {
//       setUnreadCount(0);
//       return;
...
//       (snap) => {
//         setUnreadCount(
//           snap.docs.filter((notification) => !notification.data().archived)
//             .filter(
//               (notification) =>
//                 notification.data().type === "game_release_change",
//             )
//             .length,
//         );
//       },
